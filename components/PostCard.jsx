  ...
  return (
    <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
      ...
      <div className="items-center justify-center block w-full mb-8 text-center lg:flex">
        <div className="flex items-center justify-center w-full mb-4 mr-8 md:flex lg:mb-0 lg:w-auto">
          <img 
      ...
      <p className="px-4 mb-8 text-lg font-normal text-center text-gray-700 lg:pd-20">{post.excerpt}</p>
